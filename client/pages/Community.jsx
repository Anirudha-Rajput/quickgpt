...
import { dummyPublishedImages } from "../src/assets/assets";
        ...
        <div className="flex flex-wrap max-sm:justify-center gap-5">
          {images.map((item, index) => (
            ...
            >
              ...
              />
              <p className=" absolute bottom-0 right-0 text-xs bg-black/50 backdrop-blur text-white px-4 py-l rounded-tl-xl opacity-0 group-hover:opacity-100 transition duration-300">
